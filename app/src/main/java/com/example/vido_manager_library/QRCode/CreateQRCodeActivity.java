...
public class CreateQRCodeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String name = "Tên: Tran Minh Tan";
        String class_user = "Lớp: 5T";
        String student_code = "Mã Số Sinh Viên: 2006010003";
        String inQrCode = name + "\n" + class_user + "\n" + student_code;
        ...
        try {
            BitMatrix bitMatrix = multiFormatWriter.encode(inQrCode, BarcodeFormat.QR_CODE, 300, 300);
